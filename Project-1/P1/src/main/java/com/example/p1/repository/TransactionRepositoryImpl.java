...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    private static final String SQL_CREATE = "INSERT INTO r_transactions (transaction_id, category_id, user_id, amount, note, transaction_date) VALUES(NEXTVAL('r_transactions_seq'), ?, ?, ?, ?, ?)";
    private static final String SQL_FIND_BY_ID = "SELECT transaction_id, category_id, user_id, amount, note, transaction_date FROM r_transactions WHERE user_id = ? AND category_id = ? AND transaction_id = ?";
    private static final String SQL_FIND_ALL = "SELECT transaction_id, category_id, user_id, amount, note, transaction_date FROM r_transactions WHERE user_id = ? AND category_id = ?";
    private static final String SQL_UPDATE = "UPDATE r_transactions SET amount = ?, note = ?, transaction_date = ? WHERE user_id = ? AND category_id = ? AND transaction_id = ?";
    private static final String SQL_DELETE = "DELETE FROM r_transactions WHERE user_id = ? AND category_id = ? AND transaction_id = ?";
